  ...
  void initState() {
    ...
    pinTextController.addListener(() {
      ...
      if (txt.length > 6) {
        ...
        pinTextController.selection = TextSelection.fromPosition(TextPosition(offset: 6));
      }
      ...
      body: Stack(
        children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Text(
                                  pin.isEmpty ? 'ENTER PIN' : _formatPinForDisplay(pin),
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: MobileScanner(
                                        ...
                                        onDetect: (capture) {
                                          final barcode = capture.barcodes.firstWhere((b) => b.rawValue != null, orElse: () => capture.barcodes.first);
          ...
          AnimatedPadding(
            ...
            padding: EdgeInsets.only(bottom: bottomInset + 16, left: 24, right: 24),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: isPinSelected
                      ? (pin.length >= 4 ? () => Navigator.of(context).pop(pin) : null)
                      : () {},
                  child: Text(
                    'JOIN NOW',
                    style: TextStyle(color: Colors.deepPurple[700], fontWeight: FontWeight.w700),
                  ),
                ),
              ),
            ),
            ...
            itemBuilder: (context, i) {
              ...
              return ElevatedButton(
                ...
                onPressed: () {
                  ...
                  if (k == '*') return; // optional action
                  appendDigit(k);
                },
                child: k == '⌫'
                    ? const Icon(Icons.backspace_outlined)
                    : Text(k, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w600)),
              );
            },
          ),
          const SizedBox(height: 8),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          IconButton(
            onPressed: () {},
            icon: const CircleAvatar(backgroundColor: Color(0xFF4B2FFF), child: Icon(Icons.photo, color: Colors.white)),
          ),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: const LinearGradient(colors: [Color(0xFF7B4DFF), Color(0xFF6C3CFF)]),
          ...
          IconButton(
            onPressed: () {},
            icon: const CircleAvatar(backgroundColor: Color(0xFF4B2FFF), child: Icon(Icons.folder_open, color: Colors.white)),
          ),
        ],
      ),
    );
...
class _ScannerOverlayPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final rect = Rect.fromLTWH(size.width * 0.05, size.height * 0.05, size.width * 0.9, size.height * 0.9);
    ...
    canvas.drawLine(Offset(rect.right, rect.bottom - len), Offset(rect.right, rect.bottom), cornerPaint);
  }
